...
import antiqueatlasautomarker.custombiometiles.BetterNetherCompat;
import antiqueatlasautomarker.custombiometiles.BiomesOPlentyCompat;
import antiqueatlasautomarker.custombiometiles.CustomMarkers;
import antiqueatlasautomarker.custombiometiles.DefiledLandsCompat;
import antiqueatlasautomarker.custombiometiles.DregoraCompat;
import antiqueatlasautomarker.custombiometiles.NetherTiles;
import antiqueatlasautomarker.custombiometiles.ThaumcraftCompat;
import antiqueatlasautomarker.custombiometiles.TraverseCompat;
...
public class AntiqueAtlasAutoMarker {
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        if(event.getSide() == Side.CLIENT) {
            if (ConfigHandler.overhaul.tileConfig.modifyBiomeDetection) NetherTiles.registerTiles();
