...
public class AntiqueAtlasAutoMarkerPlugin implements IFMLLoadingPlugin {
	...
	public AntiqueAtlasAutoMarkerPlugin() {
		...
		FermiumRegistryAPI.enqueueMixin(true, "mixins.aaam.antiqueatlas.tiles.colorisedvanillatiles.json", () -> !EarlyConfigReader.getString("Use Colorised Vanilla Tiles", ConfigHandler.overhaul.tileConfig.useColorisedVanillaTiles.toString()).equals("NONE"));
