...
public class AARCCompat {
    private static final Map<String, AutoMarkSetting.Data> cachedAarcSettings = new HashMap<>();

    @Nullable
    private static AutoMarkSetting.Data getCachedSetting(String structureName){
        if(!cachedAarcSettings.containsKey(structureName)){
            ...
            cachedAarcSettings.put(structureName, new AutoMarkSetting.Data(true, aarcSetting[2],type,""));
        }
        return cachedAarcSettings.get(structureName);
    }

    @Nullable
    public static AutoMarkSetting.Data getAARCSetting(String context){
        ...
        if(context_structureName.length == 2) {
            ...
            AutoMarkSetting.Data clientSetting = getCachedSetting(structureName);
            ...
            else return new AutoMarkSetting.Data(true, "DEFAULT", "DEFAULT", "AARCAddon");
        } else
