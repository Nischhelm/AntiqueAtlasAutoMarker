...
public class EnchMarkSetting {
    ...
    public static void init() {
        if(ConfigHandler.automark.enchantments.enchantmentsToMark.length == 1 && ConfigHandler.automark.enchantments.enchantmentsToMark[0].equals("ALL"))
            acceptAll = true;
        else {
            for (String s : ConfigHandler.automark.enchantments.enchantmentsToMark) {
