...
public class BetterEndCompat {
    ...
    public static void registerTiles(){
        ...
        TextureSet iceStarfieldVoid = new TextureSet("BE_ICE_STARFIELD_VOID", tileLoc("ice_starfield_void2"), Textures.TILE_END_VOID).stitchToMutual(TextureSet.END_VOID);
        ...
        TextureSet neonOasis = new TextureSet("BE_NEON_OASIS", tileLoc("neon_oasis4"));
