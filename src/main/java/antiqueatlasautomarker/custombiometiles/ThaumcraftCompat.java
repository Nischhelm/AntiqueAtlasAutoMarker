...
public class ThaumcraftCompat {
    public static void registerTiles(){
        ...
        TextureSet magicalForest = new TextureSet("TC_MAGICAL", tileLoc("tc_magicalforest1"), tileLoc("tc_magicalforest2"), tileLoc("tc_magicalforest3"), tileLoc("tc_magicalforest4"), tileLoc("tc_magicalforest5"));
        ...
        api.setBiomeTexture(BiomeHandler.MAGICAL_FOREST, magicalForest);
