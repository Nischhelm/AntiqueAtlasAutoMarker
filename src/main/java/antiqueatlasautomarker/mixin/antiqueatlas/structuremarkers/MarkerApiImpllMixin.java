...
public abstract class MarkerApiImpllMixin {
    ...
    private Marker rerouteGlobalMarkers(MarkersData instance, String type, String label, int dimension, int x, int z, boolean visibleAhead, Operation<Marker> original, @Local(argsOnly = true) World world){
    ...
    private boolean dontSendToAll(IMessage message, @Local Marker marker){
